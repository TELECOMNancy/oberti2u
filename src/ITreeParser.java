 ...
 * @author : Rehioui walid - Lata Warren - Khay Oussama - Eliott Lallement
 * Pour Tiger - PCL 2018 - TELECOM Nancy
 */
 ...
 public interface ITreeParser {
    ...
    */
   public void prettyprintTDS(ArrayList<NodeTDS> array);

   /*
    * Affiche dans la sortie standard toutes les TDS produites par init()
    */
   public void printTDS(NodeTDS rootnode,ArrayList<NodeTDS> Array);
