...
public class TreeTraversal {
    			...
    			switch (child.getType()) {
                    ...
                    case AlgolParser.BLOCK:
                        for(int j=0;j<child.getChildCount();j++){
                            ...
                            System.out.println("hello"+ Child1.getText());
                	...
                	case AlgolParser.LABEL:
                       ...
                       // System.out.println(root.getParent().getText());
                	...
                	case AlgolParser.BEGIN:
                		if (onlyDeclarations) {
                           // System.out.println("ICII"+child.getText());
    ...
    private void traverseFunction(Tree functionNode, boolean onlyDeclarations) {
        ...
        //BlocType blocType = this.traverseBloc(functionNode.getChild(1), EnumTypeTableSymbole.PROCEDURE, true);
        ...
        TDS.tableDesSymboles symbolTable1 = func.buildSymbolTable();
        SymbolFonction print= new SymbolFonction(root, "print", Scope.FUNCTION,"VOID",symbolTable,1);
       ...
       // System.out.println(symbolTable1.getRegionNum());
...
String type=structureNode.getChild(0).getText();
    ...
    private Type traverseFunctionCall(Tree functionCallNode)  {
        ...
        for (int i = 1; i < realSize + 1; i++){
            ...
            String realType = functionSymbol.returnParam().get(i-1).getType();
            Type type = traverseExpr(param);
            if(!type.getType().equals(realType)){
                System.out.println("The argument "+ param.getText() + " is called with the wrong type (" + type.getType().getToken() + " instead of " + realType+ "). Line :" + functionCallNode.getLine());
            }
        }
